...
public class MethodsExercise {
    ...
    public static void main(String[] args) {
        ...
        // CALL GET INT
        System.out.println(getInteger(1, 10, scan));
        // CALL MOD
...
//        System.out.println(counter(0));
    ...
    public static long getInteger(int min, int max, Scanner scan) {
    ...
    public static long factorial(Scanner scan) {
        System.out.println("Want to know the factorial of a number? (1-10): ");
        // FER used factorial(getInteger(1, 10) to return a number;
        ...
        if(userInput >= 1 && userInput <= 10) {
            ...
            if(userChoice.equals("y") || userChoice.equals("y".toUpperCase())){
                return userInput = factorial(scan);
            } else {
                return 0;
            }
    }
    ...
    public static void diceRoll(Scanner scan) {
        ...
        while(true) {
            if(rollOrQuit(scan).trim().equalsIgnoreCase("roll")) {
                System.out.println(rollResult(scan));
            } else {
                break;
            }
        }
    ...
    public static int getDieSides(Scanner scan) {
    ...
    public static String rollOrQuit(Scanner scan) {
    ...
    public static String rollResult(Scanner scan) {
        int sides = getDieSides(scan);
